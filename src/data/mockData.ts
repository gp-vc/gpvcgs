...
export const MOCK_DATA: Country[] = [
    {
        ...
        wineries: [
            ...
            },
            {
                ...
                wineryTitle: 'Bodega El Capricho [보데가 엘카프리초] – 미식의 거장, José Gordón의 두 번째 열정',
                ...
                logoUrl: '/images/elcaprichologo.png',
                wines: [
                    {
                        wineSlug: "valdecedin",
                        name: "Valdecedin",
